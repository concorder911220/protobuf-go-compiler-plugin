...
func GenerateModule(services []Service, generateService bool, modulePath string, outputPath string) error {
	if !generateService {
		return nil
	}
	...
	tmplPath := filepath.Join(outputPath, "templates", modulePath, "module.tmpl")
	...
	_outputPath := filepath.Join(dirPath, "module.go")
